...
class amr extends StatelessWidget {
  const amr({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('Autonomous Mobile Robotics',
          style: TextStyle(
            color: Colors.white,
      ...
      ListTile(
        ...
        body: const SingleChildScrollView(
          child: Column(children: [
            Image(image: AssetImage('assets/png/1.png'),),
            amr1(
              name: 'Autonomous Mobile Robotics',
              location: 'Designing, bulding and maintaining robots to solve problems in industries from manufacturing to aerospace, mining to medicine.',
