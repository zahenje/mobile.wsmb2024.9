...
class its extends StatelessWidget {
  const its({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('IT Software Solutions for Business',
          style: TextStyle(
            color: Colors.white,
            fontSize: 19,
      ...
      ListTile(
        ...
        body: const SingleChildScrollView(
          child: Column(children: [
            Image(image: AssetImage('assets/png/5.png'),),
            amr1(
              name: 'IT Software Solutions for Business',
              location: 'Creating new systems and modifying existing ones to provide software solutions to large and small businesses.',
